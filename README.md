...
3. WatchMe → **Switches** (next to Devices / Layers / Log) → click the orange LED under STAGE 1 / STAGE 2 for that NDI. It auto-fits the canvas. Or **Assets → NDI** and drag it onto a timeline layer **in front of** the video.

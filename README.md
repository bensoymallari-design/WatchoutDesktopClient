...
3. WatchMe → **Switches** (next to Devices / Layers / Log) → click the Stage 1 / Stage 2 circle for that NDI. It auto-fits the canvas. Or **Assets → NDI** and drag it onto a timeline layer **in front of** the video.

...
public class GpuLayerMathTests
{
    ...
    public void OutputPresentsAtTheScreenSizeNotThe64HostStub()
    {
        ...
        var stage1920OnX20 = OutputViewMath.OutputViewport(0, 0, 1920, 1080, 516, 430);
        var filledX20 = GpuLayerMath.MapRect(new StageRect(0, 0, 1920, 1080), stage1920OnX20.OriginX, stage1920OnX20.OriginY, stage1920OnX20.ScaleX, stage1920OnX20.ScaleY);
        Assert.Equal(516, (int)Math.Round(filledX20.W));
        Assert.Equal(430, (int)Math.Round(filledX20.H));
        ...
        Assert.Equal(3730, (int)Math.Round(almostMapped.W));
        Assert.Equal(2098, (int)Math.Round(almostMapped.H));

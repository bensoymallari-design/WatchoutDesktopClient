...
public class GpuLayerMathTests
{
    ...
    public void StageYieldsTheFilePreviewWhileOutputIsLive()
    {
        ...
        Assert.False(GpuLayerMath.SoftPreviewShouldGrab(22_000, 22_400, 250, true, true));
        Assert.True(GpuLayerMath.SoftPreviewShouldGrab(22_000, 24_000, 2000, true, true));
        Assert.False(GpuLayerMath.SoftPreviewShouldGrab(7_409, 7_409, 200, false, true));
        Assert.False(GpuLayerMath.SoftPreviewShouldGrab(7_409, 8_000, 80, false, true));
        Assert.True(GpuLayerMath.SoftPreviewShouldGrab(7_409, 8_000, 400, false, true));
        Assert.True(GpuLayerMath.SoftPreviewHoldWhenCpuFull(99, true));
        Assert.False(GpuLayerMath.SoftPreviewHoldWhenCpuFull(99, false));
        Assert.False(GpuLayerMath.SoftPreviewHoldWhenCpuFull(10, true));
        Assert.False(GpuLayerMath.SoftPreviewShouldGrab(22_000, 24_000, 2000, true, true, cpuPercent: 99));
        Assert.Equal(2000, GpuLayerMath.SoftPreviewPlayGrabMs);
        Assert.Equal(640, GpuLayerMath.SoftPreviewMaxEdge);

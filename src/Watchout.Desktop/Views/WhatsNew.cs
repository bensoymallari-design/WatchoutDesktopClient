        ...
        Content = new ScrollViewer
        {
            ...
            Content = new TextBlock
            {
                ...
                Text =
                    ...
                    "Colorlight X20 / LED maps — WatchMe used to copy EDID 1920×1080 and ignore the sending-card size (516×430 and similar). Devices now shows that custom Windows mode. Use size copies 516×430 onto Stage; Output presents at that size. A 1920×1080 cue cannot fill a 516×430 wall — Use size, then Fit cue.\n" +

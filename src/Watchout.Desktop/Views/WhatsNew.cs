        ...
        Content = new ScrollViewer
        {
            ...
            Content = new TextBlock
            {
                ...
                Text =
                    ...
                    "Output black/stuck with Stage — two 4K MediaElements (Producer Stage + the wall) freeze Intel UHD DXVA, so both go black. Output keeps the only HWND decode. Stage uses a software RGB32 preview (hardware transforms off, capped 1280) so the cue still has picture at Pause/Play. One shared decode when D3D11 is up. Log: “Stage software preview — Output keeps the only DXVA decode”.\n" +

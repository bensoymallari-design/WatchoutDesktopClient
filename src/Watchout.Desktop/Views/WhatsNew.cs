        ...
        Content = new ScrollViewer
        {
            ...
            Content = new TextBlock
            {
                ...
                Text =
                    ...
                    "Stage cue names — each clip on Producer Stage has a small name plate (bottom-left) so you can tell cues apart while Output is live. The wall itself stays unlabeled.\n" +

        ...
        Content = new ScrollViewer
        {
            ...
            Content = new TextBlock
            {
                ...
                Text =
                    ...
                    "Stage column switches — Devices / Layers / Log / Switches. The Switches tab is circular radios: Stage 1 / Stage 2 columns, Card 1 / Card 2 / NDI 1 rows. Click a circle to assign that input and auto-fit it to that Stage canvas.\n" +
                    ...
                    "Devices tab — Producer opens on Devices (screens, capture, audio) in the lower-right, not Layers. Layers, Log, and Switches are next to it. Switches is the Card 1 / NDI 1 radio matrix for Stage 1 / Stage 2.\n" +

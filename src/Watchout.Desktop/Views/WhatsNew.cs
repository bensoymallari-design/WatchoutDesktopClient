        ...
        Content = new ScrollViewer
        {
            ...
            Content = new TextBlock
            {
                ...
                Text =
                    ...
                    "CPU / GPU / memory — the strip above Devices, Layers, and Log shows live load as left-to-right bars (CPU · RAM · GPU) plus a green/amber/red status line. Green = room for more Stage or video. Amber = tight (another 4K may hitch). Red = full; do not add another clip until you stop Output or drop a layer. Crossing amber/red also writes a warning in Log.\n" +

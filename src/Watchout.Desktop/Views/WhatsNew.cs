        ...
        Content = new ScrollViewer
        {
            ...
            Content = new TextBlock
            {
                ...
                Text =
                    ...
                    "Colorlight X20 / Resolume — HDMI Screen stays 1920×1080. Set Stage to 516×430 (Composition). Output places that map 1:1 top-left on the 1920 wall with black around it, same as Resolume Arena. Do not change NVIDIA to 516 and do not select leftover 6720×1344.\n" +

        ...
        Content = new ScrollViewer
        {
            ...
            Content = new TextBlock
            {
                ...
                Text =
                    ...
                    "Stage column switches — Devices / Layers / Log / Switches. The Switches tab is an H9-style panel: SCREEN tiles, HDMI/NDI input cards, orange LED lamps. Click a lamp to assign that input and auto-fit it to that Stage canvas.\n" +

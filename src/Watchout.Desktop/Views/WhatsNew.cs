        ...
        Content = new ScrollViewer
        {
            ...
            Content = new TextBlock
            {
                ...
                Text =
                    ...
                    "Cue Width × Height — Properties shows pixel size on Stage (not only Scale %). A small cue looked “fit” on the TV because it stayed inside the Output window; Fit cue to the 3840 Stage used to draw larger than that window and crop (zoom). Fit cue now shows the whole picture at the Stage size. Type Width/Height for a custom box.\n" +

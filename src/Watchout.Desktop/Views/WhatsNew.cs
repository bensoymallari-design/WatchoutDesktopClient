        ...
        Content = new ScrollViewer
        {
            ...
            Content = new TextBlock
            {
                ...
                Text =
                    ...
                    "Uninstall / hung Output — setup and uninstall force-kill WatchMe.exe and re-apply Windows Extend so a topmost black Output cannot stay on the wall. Esc hides Output immediately; DXGI no longer takes exclusive fullscreen via Alt+Enter. If Win+P still leaves HDMI black, reboot once — that is a stuck GPU link, not a leftover window.\n" +

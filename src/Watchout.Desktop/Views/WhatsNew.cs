        ...
        Content = new ScrollViewer
        {
            ...
            Content = new TextBlock
            {
                ...
                Text =
                    ...
                    "Cue Width × Height — Properties shows pixel size on Stage (not only Scale %). Fit cue (toolbar or Properties) fills the display, so a 1920 clip on a 3840×2160 canvas covers the TV. Type Width/Height to size it yourself.\n" +

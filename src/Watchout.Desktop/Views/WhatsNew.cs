        ...
        Content = new ScrollViewer
        {
            ...
            Content = new TextBlock
            {
                ...
                Text =
                    ...
                    "Stage size from Windows — picking a display copies the Windows resolution onto that Stage (1920×1080 Windows → 1920×1080 Stage), not the controller EDID. A 150% DPI 4K panel still uses the physical 3840 pixels. Output HWND matches those same pixels.\n" +

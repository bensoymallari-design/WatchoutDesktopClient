        ...
        Content = new ScrollViewer
        {
            ...
            Content = new TextBlock
            {
                ...
                Text =
                    ...
                    "Cue Width × Height — Properties shows pixel size on Stage (not only Scale %). Fit cue (toolbar or Properties) contain-fits the whole picture on the display so a 4K clip is not cropped/zoomed. Type Width/Height to size it yourself.\n" +

        ...
        Content = new ScrollViewer
        {
            ...
            Content = new TextBlock
            {
                ...
                Text =
                    ...
                    "Import of a file video (HandBrake MP4, YouTube yt-dlp) plays the original 8-bit H.264. WatchMe does not encode HAP in the background — that used CPU/RAM during Play and aborted on this PC (ffmpeg Unrecognized option chunks). If D3D11 is off, Output keeps the only DXVA decode and Stage is a software preview (not a second 4K MediaElement). Assets → Encode HAP is optional for a clip already in the list. Notch LC / ProRes still transcode to H.264. WAV files can declare up to 65535 channels; WatchMe downmixes wide files to stereo for playback. Export LTC WAV from the timeline playhead; ChaseLtc follows SMPTE time. Win+Shift+S / Print Screen used to close WatchMe when GPU memory was full — that error is caught and Play continues.\n\n" +
